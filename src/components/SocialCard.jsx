...
const SocialCard = ({imgURL, label, href}) => {
  return (
    <a href={href}>
        <div class="flex-1 flex gap-5 min-w-[200px] lg:min-w-[250px] w-full rounded-[20px] px-3 py-2 lg:py-3 ring-1 items-center ring-slate-900/15 hover:bg-slate-900/15 dark:hover:bg-slate-500/20 dark:bg-slate-300/5">
