const EventCard = ({imgURL, label, date, location}) => {
  return (
    <div class="flex-1 flex gap-5 min-w-[300px] max-w-[600px] w-full rounded-[20px] shadow-3xl px-6 lg:px-10 py-5 lg:py-7 ring-1 ring-slate-900/5 dark:bg-slate-600 items-start">
