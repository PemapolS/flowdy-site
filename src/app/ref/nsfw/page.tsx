                ...
                <table className="min-w-full max-w-2xl w-full table-fixed bg-transparent">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                      ...
                      <td className="py-2 text-sm text-gray-900 dark:text-white">5.5" / 14 cm</td>
                    </tr>

                    <tr>
                      <th scope="row" className="text-left py-2 pr-4 text-sm font-medium text-gray-600 dark:text-gray-300">Penis Girth</th>
