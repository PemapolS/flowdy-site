...
const Partners = () => {
  return (
    <>
      ...
      <section 
        id="partners-fez"
        className="w-full py-20 flex items-center justify-center bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/30"
      ...
      <section 
        id="partners-bluejay"
        className="w-full py-20 flex items-center justify-center bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/40"
